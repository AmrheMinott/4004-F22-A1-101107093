...
public class GameLogicTest {
    ...
    @Nested
    @DisplayName("Captain Card Testing")
    class CaptainCard {
        @Test
    ...
    @Nested
    @DisplayName("Monkey Business Card Testing")
    class MonkeyBusinessCard {
        @Test
    ...
    @Nested
    @DisplayName("Sea Battle Card Testing")
    class SeaBattleCard {
        @Test
    ...
    @Nested
    @DisplayName("Chest Card Testing")
    class ChestCard {
        @Test
    ...
    @Nested
    @DisplayName("Diamond & Gold Card Testing")
    class DiamondGoldCard {
        @Test
    ...
    @Nested
    @DisplayName("Skull Card Testing")
    class SkullCard {
        @Test
    ...
    @Nested
    @DisplayName("Island of the Dead Calculations Testing")
    class IslandOfTheDeadCard {
        @Test
        public void givenTwoSkullCard_assertDeductionsOfFourSkulls() {
            ...
            assertEquals(-400, gameLogic.scoreIslandOfTheDeadDeduction(dice, null));
        }
        ...
        public void givenTwoSkullCard_assertDeductionsOfMidSkulls() {
            ...
            assertEquals(-800, gameLogic.scoreIslandOfTheDeadDeduction(dice, null));
        }
        ...
        public void givenTwoSkullCard_assertDeductionsOfAllSkulls() {
            ...
            assertEquals(-1000, gameLogic.scoreIslandOfTheDeadDeduction(dice, null));
        }
